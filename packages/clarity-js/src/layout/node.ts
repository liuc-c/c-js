        ...
        case Node.ELEMENT_NODE:
            ...
            switch (tag) {
                ...
                case "NOSCRIPT":
                    ...
                    break;
                case "META":
                    let key = (Constant.Property in attributes ?
                                    Constant.Property :
                ...
                case "LINK":
                    ...
                    if (electron && attributes['rel'] === Constant.StyleSheet) {
                        for (let styleSheetIndex in Object.keys(document.styleSheets)) {
                            let currentStyleSheet = document.styleSheets[styleSheetIndex];
