...
export function envelope(tokens: Data.Token[]): Data.Envelope {
    ...
    return {
        ...
        start: tokens[2] as number,
        duration: tokens[3] as number,
        domainId: tokens[4] as string,
        pv: tokens[5] as string,
        uuid: tokens[6] as string,
        sessionId: tokens[7] as string,
        pageNum: tokens[8] as number,
        upload: tokens[9] as Data.Upload,
        end: tokens[10] as Data.BooleanFlag
    };
}
